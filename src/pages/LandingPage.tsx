    ...
    <div style={{ minHeight: '100vh', background: '#080810', color: '#e2e8f0', fontFamily: 'system-ui, -apple-system, sans-serif', position: 'relative' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <img src="/gridlogo.png" alt="NyxGrid" style={{ height: 72, width: 'auto', filter: 'drop-shadow(0 0 12px #8b5cf6)' }} />
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', maxWidth: 760, margin: '0 auto' }}>
          <img src="/gridlogo.png" alt="NyxGrid" style={{ height: 280, width: 'auto', display: 'block', margin: '0 auto 40px', filter: 'drop-shadow(0 0 60px #8b5cf6)' }} />
          <div style={{
      ...
      <section style={{ padding: '80px 40px', textAlign: 'center' }}>
        <div style={{
          ...
          <img src="/gridlogo.png" alt="NyxGrid" style={{ height: 240, width: 'auto', display: 'block', margin: '0 auto 32px', filter: 'drop-shadow(0 0 50px #8b5cf6)' }} />
